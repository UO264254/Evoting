...
/**
 * 
 * @author marco Classe adoperata per rappresentare una persona (votante o
 *         candidato).
 */
public class Person extends Parsable {
	...
	public enum DocumentType {
		CARTA_IDENTITA, PATENTE, PASSAPORTO, CONOSCENZA_PERSONALE
	}
	...
	// Codice identificativo univoco della persona, da decidere (matricola, CF,
	...
	/**
	 * Costruttore per il candidato durante la fase di votazione, setta tutti
	 * valori, i quali non potranno essere cambiati.
	 * 
	...
	/**
	 * Costruttore per il candidato durante la fase di scrutinio, setta tutti
	 * valori, i quali non potranno essere cambiati.
	 * 
	 * @param firstName Nome.
	 * @param lastName  Cognome.
	...
	/**
	 * Costruttore per il votante, setta tutti valori, i quali non potranno essere
	 * cambiati.
	 * 
	 * @param firstName   Nome.
	 * @param lastName    Cognome.
	 * @param ID          Codice identificativo.
	 * @param ballotCodes Lista di interi relativi alle schede che il votante può
	 *                    votare.
	 * @param mayVote
	 */
	 ...
	 * @param String      email
	 */
	public Person(String firstName, String lastName, String ID, int[] ballotCodes, boolean mayVote, String email) {
		this.firstName = firstName;
		this.lastName = lastName;
		this.ID = ID;
		this.ballotCodes = ballotCodes;
	...
	public Person(String firstName, String lastName, String email, String ID, int[] ballotCodes, boolean mayVote,
			String birth) {
		this.firstName = firstName;
		this.lastName = lastName;
		this.email = email;
	...
	/**
	 * Restituisce se la persona ha diritto a votare almeno per una scheda della
	 * sessione attuale. Sempre falso per i candidati, falso per un votante se ha
	 * già votato nella sessione.
	 * 
	...
	public void setDocumentType(String type) {
		Map<String, DocumentType> typeStringToDocumentType = Map.of("Carta d'Identità", DocumentType.CARTA_IDENTITA,
				"Patente", DocumentType.PATENTE, "Passaporto", DocumentType.PASSAPORTO, "Sin Documentación",
				DocumentType.CONOSCENZA_PERSONALE);
