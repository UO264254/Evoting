...
public class FileUtils {
	...
	/**
	 * Stringa contenente tutti i caratteri permessi da file generici. Questi
	 * includono:
	 * <ul>
	...
	/**
	 * Restituisce un reader {@link BufferedReader} per il file specificato a
	 * parametro.
	 * 
	...
	/**
	 * Verifica che la stringa passata a parametro contenga solo numeri (una o più
	 * cifre).
	 * 
	...
	/**
	 * Verifica che la stringa passata a parametro contenga solo lettere
	 * (eventualmente accentate).
	 * 
	 * @param str Stringa da verificare
	...
	public static boolean isAlpha(String str) {
		...
		Pattern pattern = Pattern.compile("[a-zA-Z1-9'àèìòù\\s]+");
		return pattern.matcher(str).matches();
	}
	
	public static boolean isEmail(String str) {
		if(str == null || str.isEmpty()) {
			return true; //el usuario puede no tener email
		}
	...
	/**
	 * Verifica che la stringa passata a parametro contenga solo caratteri permessi,
	 * specificati in {@link #permittedGenericTextCharacter}.
	 * 
	 * @param str Stringa da verificare
	...
	/**
	 * Verifica che la stringa passata a parametro corrisponda ad un identificativo
	 * univoco (matricola, codice fiscale).
	 * 
	 * @param str Stringa da verificare
	...
	/**
	 * Verifica che la stringa passata a parametro corrisponda ad una data, nel
	 * formato gg/mm/aaaa.
	 * 
	 * @param str Stringa da verificare
	...
	/**
	 * Verifica che la stringa passata a parametro corrisponda ad un orario, nel
	 * formato hh:mm:ss.
	 * 
	 * @param str Stringa da verificare
	...
	public static String removeCommentsAndBlankSpaces(String line, String fieldSeparator) {
		String newLine = line.trim().replaceAll("\t+", " ").replaceAll("\\s+", " ")
				.replace(" " + fieldSeparator, fieldSeparator).replace(fieldSeparator + " ", fieldSeparator);
	...
	/**
	 * Internationalize method
	 * 
	 * @param string
	 * @return the asked string internationalized
	 */
