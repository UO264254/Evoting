...
/**
 * CNN_0: "Errore di connessione" <br>
 * CNN_1: "Destinazione irragiungibile" <br>
 * CNN_2: "Destinazione non attiva" <br>
...
public class CNNException extends PEException {
	...
	/**
	 * Generic: "Errore di connessione" <br>
	...
	/**
	 * Generic: "Destinazione irraggiungibile" <br>
	 * Specific: "Non è stato possibile contattare il terminale " + type + <br>
	 * "all'indirizzo " + ipRecipient
	 * 
	 * @param type        Stringa relativa al terminale (postazione num/ seggio/
	 *                    seggio ausiliario/ urna)
	...
	public static CNNException CNN_1(String type, String ipRecipient, Exception e) {
		String specific = FileUtils.getResourceBundle("etiqueta_no_posible_contactar_con_terminal") + " " + type;
		specific += ipRecipient != null ? " " + FileUtils.getResourceBundle("etiqueta_en_la_direccion") + " " + ipRecipient : "";
		return new CNNException(Code.CNN_1, FileUtils.getResourceBundle("etiqueta_destino_inalcanzable"), specific, e);
	}

	/**
	 * Generic: "Destinazione irraggiungibile" <br>
	 * Specific: "Non è stato possibile contattare il terminale " + type + <br>
	 * "all'indirizzo " + ipRecipient + <br>
	 * otherInfo
	 * 
	 * @param type        Stringa relativa al terminale (postazione num/ seggio/
	 *                    seggio ausiliario/ urna)
	...
	public static CNNException CNN_1(String type, String ipRecipient, String otherInfo, Exception e) {
		String specific = FileUtils.getResourceBundle("etiqueta_no_posible_contactar_con_terminal") + " " + type
				+ "\n" + FileUtils.getResourceBundle("etiqueta_en_la_direccion") + " " + ipRecipient + "\n" + otherInfo;
		return new CNNException(Code.CNN_1, FileUtils.getResourceBundle("etiqueta_destino_inalcanzable"), specific, e);
	}

	/**
	 * Generic: "Destinazione non attiva" <br>
	...
	/**
	 * Generic: "Comunicazione interrotta" <br>
	 * Specific: "Il terminale " + type + " con ip " + ipRecipient + " ha interrotto
	 * la comunicazione"
	 * 
	 * @param type        Stringa relativa al terminale (postazione num/ seggio/
	 *                    seggio ausiliario/ urna)
