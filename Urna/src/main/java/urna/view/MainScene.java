...
public class MainScene extends ViewAbstrController {
	...
	@FXML
	private MenuItem closeSessionMenu, logoutMenu, statsMenu, italianMenu, spanishMenu, englishMenu;
	...
	void changeLanguageToEnglish(ActionEvent event) {
		((Controller) controller).changeLanguage("en", "EN");
	}
	
	@FXML
	void changeLanguageToItalian(ActionEvent event) {
		((Controller) controller).changeLanguage("it", "IT");
	}
	
	@FXML
	void changeLanguageToSpanish(ActionEvent event) {
		((Controller) controller).changeLanguage("es", "ES");
	}
