	...
	protected void execute() {
		...
		switch(message) {
			...
			case Protocol.informStatePost:
				logger.debug("Seggio lee mensaje send informStatePost ");
				if(((Controller) controller).verifyIp(ip, true))
					updateStatePost();
				break;
			...
			default: 
				System.out.println("Seggio lee mensaje send informStatePost otro");
